...
Visualization based of Pygame (www.pygame.org).
"""
...
class TetrisApp(object):
    ...
    def center_msg(self, msg):
        ...
        for i, line in enumerate(msg.splitlines()):
            ...
            msgimcenterx, msgimcentery = msg_image.getsize()
            msgimcenterx //= 2
            msgimcentery //= 2

            self.screen.blit(msg_image, (
                self.width // 2-msgimcenterx,
                self.height // 2-msgimcentery+i*22)
            )
    ...
    def run(self):
        ...
        dontburnmy_cpu = pygame.time.Clock()
